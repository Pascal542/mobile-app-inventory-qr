...
class SendFacturaUseCase {
  ...
  SendFacturaUseCase(this.repository, this._getLastDocumentNumber);
  ...
  Future<(BoletaResponse, String)> call(BoletaRequest request) async {
    try {
      ...
      final response = await repository.sendFactura(newRequest);
      return (response, newId);
    } catch (e) {
      developer.log('Error en SendFacturaUseCase: $e', error: e);
